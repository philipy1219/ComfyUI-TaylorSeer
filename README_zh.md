...
| 提示词 | 原始结果 (steps = 50, 2.42it/s) | TaylorSeer (steps = 50, order = 1, 5.73it/s) | TeaCache (steps = 50, rel_l1_thresh = 0.25, 4.08it/s) | TeaCache (steps = 50, rel_l1_thresh = 0.40, 5.32it/s) |
|--------|----------|------------|-----------|-----------|
